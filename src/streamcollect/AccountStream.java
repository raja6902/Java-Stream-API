...
public class AccountStream {
	...
	public static void main(String[] args) {
		...
		//  find a account balance  greater than 150 in current account and increase a balance by 100 find sum.
		double sum =0;
		...
		double result =acctsStream.filter(e ->e.getAccountBalance()>150)
		           ...
		           .peek(e->System.out.println("Acct number is  " + e.getAccountNumber()+ "  Acct balance is  "  + e.getAccountBalance()))
